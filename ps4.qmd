...
After manually inspecting the site's HTML code, I think the title is <a> (nested in <h2>), the date is <span>, the category is <li>, and the link is <a> (nested inside of the title tag). 

The data I want starts about halfway into the HTML code.
