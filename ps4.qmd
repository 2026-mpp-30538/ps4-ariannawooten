...
```{python}
#Scrape the following into a dataframe: * Title of the enforcement action * Date * Category (e.g,
#“Criminal and Civil Actions”) * Link associated with the #enforcement action
